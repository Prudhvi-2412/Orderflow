...
CREATE TABLE IF NOT EXISTS orders (
    ...
    status VARCHAR(50) NOT NULL DEFAULT 'PENDING', -- PENDING, PROCESSING, COMPLETED, CANCELLED, FAILED
...
ALTER TABLE idempotency_keys ADD COLUMN IF NOT EXISTS claim_token VARCHAR(64);
