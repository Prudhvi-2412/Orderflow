  ...
  return (
    <div className="space-y-6">
      <HeaderBanner
        ...
        description="Complete technical documentation, distributed patterns reference, and system design interview guide for OrderFlow engine architecture."
        color="cyan"
      />
      ...
      <div className="space-y-4">
        ...
        >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 font-mono text-[11px] text-cyan-300">
          ...
          <h4 className="font-semibold text-slate-200 text-xs mt-3">Transactional Outbox Pattern</h4>
          <p>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-slate-900/60 p-4 rounded-xl border border-slate-800">
              <h4 className="font-bold text-purple-400 mb-1">Pessimistic Distributed Mutex (Redlock)</h4>
            ...
            <div className="bg-slate-900/60 p-4 rounded-xl border border-slate-800">
              <h4 className="font-bold text-amber-400 mb-1">Optimistic Locking (Version CAS)</h4>
              <p className="text-[11px] text-slate-400 leading-normal">
        ...
        <ArchitectureAccordionItem
          ...
          onToggle={toggleSection}
        >
          <p>When a client sends an <code>Idempotency-Key</code> header:</p>
        ...
        <ArchitectureAccordionItem
          ...
          onToggle={toggleSection}
        >
          <p>Circuit Breakers protect downstream resources from overload. State transitions:</p>
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 font-mono text-[11px] text-rose-300">
